...
//	headHtml += "</li>";
	...
	headHtml += "<div class='span6' style='padding: 0px 5px;margin-top:20px;'>";
	headHtml += "<p title='" + userInfo.nickName + "' style='font-weight:bold;margin:0;overflow:hidden;text-overflow:ellipsis;width:130px;' id='userName'>你好！" + userInfo.nickName + "</p>";
	headHtml += "<p title='" + userInfo.userName + "' style='font-weight:bold;margin:0;overflow:hidden;text-overflow:ellipsis;width:130px;display:none' id='userMail'>" + userInfo.userName + "</p>";
	headHtml += "<div style='margin-top:10px;'>";
