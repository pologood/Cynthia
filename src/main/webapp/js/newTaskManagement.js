...
function removeFile(fieldId)
{
	...
	for(var i = 0; i < fileReference.options.length; i++)
	{
		...
		{
			removeAttachIds.push(fileReference.options[0].value);
	...
	deleteAttachments(removeAttachIds);

}
//TODO 删除数据库里面的数据记录   2015、4、2  wendy
function deleteAttachments(removeAttachIds){
	$.ajax({
		url:  '/cynthia/template/removeAttachment.do',
		dataType:'json',
		type :'POST',
		data: {'removeAttachIds':removeAttachIds.join()},
		success: function(data){
