...
public class TemplateController extends BaseController{
	...
	public String removeAttachment(HttpServletRequest request , HttpSession httpSession) throws Exception {
		String removeAttachIds = request.getParameter("removeAttachIds");
		boolean flag = das.deleteAttachments(removeAttachIds);
